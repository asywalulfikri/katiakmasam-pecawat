 ...
 */
public class Explosion extends com.ispring.gameplane.game.Sprite {
    ...
    @Override
    protected void afterDraw(Canvas canvas, Paint paint, com.ispring.gameplane.game.GameView gameView) {
        if(!isDestroyed()){
