...
public class CombatAircraft extends Sprite {
    ...
    public void fight(GameView gameView){
        ...
        if(single){
            ...
            com.ispring.gameplane.game.Bullet yellowBullet = new com.ispring.gameplane.game.Bullet(yellowBulletBitmap);
            ...
            com.ispring.gameplane.game.Bullet leftBlueBullet = new com.ispring.gameplane.game.Bullet(blueBulletBitmap);
            leftBlueBullet.moveTo(leftX, y);
            gameView.addSprite(leftBlueBullet);

            com.ispring.gameplane.game.Bullet rightBlueBullet = new com.ispring.gameplane.game.Bullet(blueBulletBitmap);
